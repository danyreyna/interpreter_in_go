...
func TestGetNextToken(t *testing.T) {
	tests := []struct {
		...
		{bang, "", "./test-file.code", 13, 1},
		{minus, "", "./test-file.code", 13, 2},
		{slash, "", "./test-file.code", 13, 3},
		{asterisk, "", "./test-file.code", 13, 4},
		{integer, "5", "./test-file.code", 13, 5},
		{semicolon, "", "./test-file.code", 13, 6},
		{integer, "5", "./test-file.code", 14, 1},
		{lessThan, "", "./test-file.code", 14, 3},
		{integer, "10", "./test-file.code", 14, 5},
		{greaterThan, "", "./test-file.code", 14, 8},
		{integer, "5", "./test-file.code", 14, 10},
		{semicolon, "", "./test-file.code", 14, 11},
		{ifKeyword, "", "./test-file.code", 16, 1},
		{leftParenthesis, "", "./test-file.code", 16, 4},
		{integer, "5", "./test-file.code", 16, 5},
		{lessThan, "", "./test-file.code", 16, 7},
		{integer, "10", "./test-file.code", 16, 9},
		{rightParenthesis, "", "./test-file.code", 16, 11},
		{leftCurlyBrace, "", "./test-file.code", 16, 13},
		{returnKeyword, "", "./test-file.code", 17, 5},
		{trueKeyword, "", "./test-file.code", 17, 12},
		{semicolon, "", "./test-file.code", 17, 16},
		{rightCurlyBrace, "", "./test-file.code", 18, 1},
		{elseKeyword, "", "./test-file.code", 18, 3},
		{leftCurlyBrace, "", "./test-file.code", 18, 8},
		{returnKeyword, "", "./test-file.code", 19, 5},
		{falseKeyword, "", "./test-file.code", 19, 12},
		{semicolon, "", "./test-file.code", 19, 17},
		{rightCurlyBrace, "", "./test-file.code", 20, 1},
		{integer, "10", "./test-file.code", 22, 1},
		{equality, "", "./test-file.code", 22, 4},
		{integer, "10", "./test-file.code", 22, 7},
		{semicolon, "", "./test-file.code", 22, 9},
		{integer, "10", "./test-file.code", 23, 1},
		{inequality, "", "./test-file.code", 23, 4},
		{integer, "9", "./test-file.code", 23, 7},
		{semicolon, "", "./test-file.code", 23, 8},
